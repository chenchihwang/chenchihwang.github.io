---
title: CV
description: AI / ML enjoyer with a background in Big Data Infra
...
### [Amazon](https://aws.amazon.com/glue/)

<small>SDE Intern &bull; May 2026 - July 2026</small>

SDE Intern with AWS Glue - Orca;

Implementing seamless migrations from [data pipelines](https://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/what-is-datapipeline.html) to [MWAA Serverless](https://docs.aws.amazon.com/mwaa/latest/mwaa-serverless-userguide/what-is-mwaa-serverless.html).
